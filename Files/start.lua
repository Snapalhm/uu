...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot5532110851:AAGiTdSeZ8RqX5qGnQ4oyjIOrznw5CUgyZA/getchatmember?chat_id=@iinzzz&user_id='..msg.sender.user_id)
...
local Get_Files  = io.popen("curl -s https://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@raw.githubusercontent.com/P8YUO/fil/main/getfile.json"):read('*a')
...
datar[#json.plugins_ +1] = {{text = "‹ مطور السورس ›",url ="https://t.me/RFRFF"}}
end
return datar
end
...
rel = io.popen("curl -s https://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@raw.githubusercontent.com/P8YUO/fil/main/getfile.json"):read('*a')
...
local GetJson = io.popen('curl -s https://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@raw.githubusercontent.com/P8YUO/fil/main/Files/'..FileName):read('*a')
...
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "سناب"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "سناب"),"اني لقميل "..(redis:get(bot_id..":namebot") or "سناب"),(redis:get(bot_id..":namebot") or "سناب").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end 
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "سناب") then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '‹ ƚᥱᥲ️꧑ ᥉ꪀᥲ️ρ ›', url = 't.me/iinzzz'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤• عليك الاشتراك في قناة السورس اولاً ༄  ،*',"md",false, false, false, false, reply_markup)
end  
...
bot.sendText(msg.chat_id,msg.id, "\n⇜ وسوينا لك حساب في البنك ( بنك سناب 💳 )  \n\n⇜ رقم حسابك ↢ ( `"..creditcc.."` )\n⇜ نوع البطاقة ↢ ( "..gg.." )\n⇜ فلوسك ↢ ( `"..flossst.."` $ 💸 )  ","md",true)  
end 
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '‹ ƚᥱᥲ️꧑ ᥉ꪀᥲ️ρ ›',url="t.me/iinzzz"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
local T =[[
[‹ WeLCoMe To S𝘰𝘶𝘳𝘤𝘦 S𝘯𝘢𝘱 ›](t.me/iinzzz)
 [‹ Source Explanations ›](t.me/BBI9B)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ ƚᥱᥲ️꧑ ᥉ꪀᥲ️ρ ‹ ',url="t.me/iinzzz"}},
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/iinzzz&caption=' .. URL.escape(T).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
